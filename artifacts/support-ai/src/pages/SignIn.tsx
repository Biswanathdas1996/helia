      ...
      <div className="w-full max-w-[440px]">
        <div className="bg-white rounded-2xl shadow-lg border border-border overflow-hidden">
          <div className="p-8">
            ...
            <h1 className="text-xl font-semibold text-foreground text-center mb-1">Sign in to your account</h1>
            <p className="text-sm text-muted-foreground text-center mb-6">Welcome back! Please enter your details.</p>
